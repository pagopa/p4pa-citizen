...
public interface DebtPositionFacadeService {
  ...
  FileResourceDTO getUnpaidPaymentNotice(String fiscalCode, Long brokerId, Long organizationId, Long installmentId, String iuv, String iud, String accessToken);
}
