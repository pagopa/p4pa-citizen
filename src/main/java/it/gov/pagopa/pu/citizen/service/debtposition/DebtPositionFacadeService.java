...
public interface DebtPositionFacadeService {
  ...
  PagedDebtorDebtPositionDTO getPagedDebtPositions(String xFiscalCode, Long brokerId, String orgName, String orgFiscalCode, Pageable pageable, String accessToken);
}
